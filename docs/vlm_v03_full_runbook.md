...
After `llava_onevision_qwen2_0_5b`, use this order unless a prior run fails:

1. `internvl3_1b`: adds a small InternVL family row.
2. `internvl3_2b`: tests whether the earlier non-monotonic InternVL result persists.
