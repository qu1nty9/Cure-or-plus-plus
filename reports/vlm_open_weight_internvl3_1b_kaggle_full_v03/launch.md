# internvl3_1b Full v0.3 Run Launch
...
- `vlm_open_weight_runs/full/internvl3_1b/responses.jsonl`
- `vlm_open_weight_runs/full/internvl3_1b/model_summary.csv`
- `vlm_open_weight_runs/full/internvl3_1b/recipe_table.csv`
- `vlm_open_weight_runs/full/internvl3_1b/label_table.csv`
- `vlm_open_weight_runs/full/internvl3_1b/audit.csv`
...
.venv/bin/python scripts/integrate_kaggle_vlm_output.py \
  ...
  --slug internvl3_1b \
  --result-dir reports/vlm_open_weight_internvl3_1b_kaggle_full_v03 \
  --kernel-version 33 \
  --update-matrix
