# smolvlm2_2b Full v0.3 Run Launch
...
- `vlm_open_weight_runs/full/smolvlm2_2b/responses.jsonl`
- `vlm_open_weight_runs/full/smolvlm2_2b/model_summary.csv`
- `vlm_open_weight_runs/full/smolvlm2_2b/recipe_table.csv`
- `vlm_open_weight_runs/full/smolvlm2_2b/label_table.csv`
- `vlm_open_weight_runs/full/smolvlm2_2b/audit.csv`
