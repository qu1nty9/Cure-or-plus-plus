...
Qwen2.5-VL-3B.
The hosted-provider path has nine completed rows on the 210-row prompt pack:
...
reaches 0.9556, GPT-5.5 and Claude Haiku 4.5 reach 0.9500, and GigaChat 2 Pro
