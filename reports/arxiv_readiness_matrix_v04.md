...
| VLM/API track | Runner-ready, not executed on real providers | `configs/vlm_api_track_v01.json`, `reports/vlm_api_track_v01_prompt_pack.jsonl`, `scripts/run_openai_compatible_vlm.py`, `scripts/evaluate_vlm_response_pack.py`, 210 prompt rows/model | run selected provider/open-weight models and report raw-response audit rules |
