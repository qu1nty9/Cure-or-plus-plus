...
The v0.3 900-row VLM real-transfer extension now has six completed
open-weight rows: Qwen2.5-VL-7B, LLaVA-OneVision Qwen2 7B,
LLaVA-OneVision Qwen2 0.5B, InternVL3-1B, SmolVLM2-2.2B, and Qwen2.5-VL-3B.
...
- completion of the v0.3 900-row open-weight VLM scale/family extension beyond the current six rows;
